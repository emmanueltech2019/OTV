...
import bg from "@/assets/wines/vinedos4.jpg";
import wineImg from "@/assets/wines/lindaflor-malbec.png";
        ...
        <div id="main " className="h-fit w-screen bg-gray-200">
          <div className="relative h-[70vh] bg-white">
            ...
            >
              <Image
                src={wineImg}
                className="w-[40vw] h-[65vh] md:h-screen md:w-[30vw]"
                alt=""
            ...
            <div className="bg-white h-32 w-32 rounded-full absolute top-[200px] md:top-[300px] right-5 md:right-[42vw] flex flex-col justify-center items-center">
              ...
              <span className="text-gray-700">9824 rating</span>
            </div>
            ...
            <div className="bg-white my-3 py-5 px-3 text-gray-700  md:w-1/2 md:pl-[200px]">
              ...
              <div className="flex justify-between">
                <p>
                  Brilliant and deep ruby color with violet hues. Elegant fragrance, aromas of violets, plums and cherries. Balanced, with a refreshing acidity and velvety tannis. its outstanding and smooth finish provides a subtle aftertaste. 
