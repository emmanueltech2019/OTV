...
import bg from "@/assets/wines/mariflor-bg.jpg";
import wineImg from "@/assets/wines/mariflor-camille.png";
      ...
      <div id="main " className="h-fit w-screen bg-gray-200">
        <div className="relative h-[70vh] bg-white">
          ...
          <div className="bg-white h-32 w-32 rounded-full absolute top-[200px] md:top-[300px] right-5 md:right-[42vw] flex flex-col justify-center items-center">
            ...
            <span className="text-gray-700">921 rating</span>
          </div>
          ...
          <div className="flex md:flex-row flex-col   md:w-screen">
            ...
            <div className="bg-white my-3 py-5 px-3 text-gray-700  md:w-1/2 md:pr-[200px]">
              ...
              <div className="flex justify-between">
                <div className="flex py-3">
                  <InfoIcon />
                  <p className="pl-3">Malbec, Merlot</p>
                </div>
                <div className="flex">
          ...
          <div className="bg-white my-3 py-5 px-3 text-gray-700  md:w-1/2 md:pl-[200px]">
            ...
            <div className="flex justify-between">
              <p>
              A very dark crimson colour, the nose reveals incredibly complex aromas of black cherry and blackberry with nuances of fruit compote and surprising aromatic intensity.

All in all, a powerful, elegant and well-balanced yet tannic wine, perfect for all occasions great and small.

Its seemingly endless ageing potential (easily 20, 30, or 40 years) makes it appear indestructible.
