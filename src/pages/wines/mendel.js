...
import wineImg from "@/assets/wines/mendel.png";
...
Mendel</span>
          ...
          <div className="bg-white my-3 py-5 px-3 text-center flex flex-col md:flex-row justify-center md:justify-left items-center">
            ...
            <div>
              ...
              <div className="bg-gray-200 rounded-full py-3 px-10 ">
                <p className="pt-5">Argentina, Malbec</p>
              </div>
            </div>
            <div>
          ...
          <div className="bg-white my-3 py-5 px-3 text-gray-700  md:w-1/2 md:pl-[200px]">
            ...
            <div className="flex justify-between">
              <p>
                Notes like exotic spices, sandalwood, violets and lavander, fresh and ripe fruits -such as black cherries, plums and blueberries. After the fruits, appear spices and notes from the oak such as vanila, chocolate, caramel and blond tobacco, which denote the oak ageing in new france oak. Also some black liquorice notes appear at the end giving more complexity to the whole
              </p>
            </div>
          </div>
