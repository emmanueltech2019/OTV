...
import bg from "@/assets/wines/zuccardi-1.jpeg";
import wineImg from "@/assets/wines/poligonos.png";
...
Zuccardi</span>
          ...
          <div className="bg-white my-3 py-5 px-3 text-gray-700  md:w-1/2 md:pl-[200px]">
            ...
            <div className="flex justify-between">
              <p>
              Through each of its wines, Zuccardi Valle de Uco expresses the essence of its origin: a unique combination of the mountain landscape, high altitude climate, soil and people. Every wine range represents a concept, a belief and a tribute, and is the faithful expression of the vineyard where it was born. The winery’s ascending path has been led by Sebastián Zuccardi, who has worked hand in hand with a young team of growers and winemakers to craft wines with identity through the relentless exploration of the diverse terroirs of the Uco Valley.
