...
import wineImg from "@/assets/wines/pulenta-gran-xi.png";
      ...
      <div id="main " className="h-fit w-screen bg-gray-200">
        <div className="relative h-[70vh] bg-white">
          ...
          <div className="flex flex-row bg-white pb-10 md:mt-[100px] md:my-[10px]">
            ...
            <div className="w-[50vw] pr-10 flex flex-col justify-center md:justify-left items-center md:items-start">
              <div className=" mt-[70px] ">
                ...
                Pulenta Estate</span>
                <br />
                <b>Gran Cabernet Franc (XI) 2017</b>
              </div>
          ...
          <div className="bg-white my-3 py-5 px-3 text-gray-700  md:w-1/2 md:pl-[200px]">
            ...
            <div className="flex justify-between">
              <p>
              Intense dark violet color, with a surprising brightness. Aromas of red fruit and cherries. combined  with subtle notes of violet and purple flowers, making the varietal presence. Delicate toasted aromas, given by the oak.
              </p>
            </div>
          </div>
